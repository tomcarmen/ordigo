...
<?php if ($action === 'list'): ?>
    <!-- Lista Prodotti -->
    <div class="bg-white/80 backdrop-blur shadow-lg rounded-xl ring-1 ring-gray-200/60">
        <div class="px-4 py-5 sm:p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Gestione Prodotti</h3>
                <div class="flex space-x-3">
                    <button type="button" onclick="openAddProductModal()" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-md text-sm shadow-sm">
                        <i class="fas fa-plus mr-2"></i>Nuovo Prodotto
                    </button>
                    <input type="text" id="search-products" placeholder="Cerca prodotti..." class="rounded-md px-3 py-2 text-sm border border-gray-300 ring-1 ring-gray-200 focus:border-blue-500 focus:ring-blue-500 shadow-sm">
            ...
            <div class="overflow-x-auto ring-1 ring-gray-200/60 rounded-lg">
...
<?php elseif ($action === 'add' || $action === 'edit'): ?>
    ...
    <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" role="dialog" aria-modal="true" aria-labelledby="<?= $action === 'add' ? 'addPageModalTitle' : 'editPageModalTitle' ?>">
        <div class="relative top-12 mx-auto p-6 border border-gray-100 max-w-5xl w-full shadow-xl rounded-xl bg-white">
            <div class="mt-3">
...
<div id="add-product-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden" role="dialog" aria-modal="true" aria-labelledby="addProductModalTitle">
    <div class="relative top-12 mx-auto p-6 border border-gray-100 max-w-2xl w-full shadow-xl rounded-xl bg-white">
        <div class="mt-3">
            ...
            <?php endif; ?>
            <form id="add-product-form" method="POST" enctype="multipart/form-data" action="?route=admin&page=products&action=add" class="space-y-6">
